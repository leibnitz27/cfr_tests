...
public class TwelveDays {
    ...
    public static void main(String[] args) {
        ...
        switch (dd) {
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 1 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 2 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 3 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 4 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 5 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 6 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 7 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 8 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 9 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 10 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 11 -> {}
            case Day(int a, _, _, _, _, _, _, _, _, _, _, _) when a == 12 -> {}
            default -> {}
        }
    }
}